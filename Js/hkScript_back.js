...
function WriteTagLocalScene(username, password, method, ip, port, token, tagid, value, type, callback) {
    $.ajax({
        type: 'GET',
        url: Handler,
        dataType: 'json',
        ...
        error: function (data) {
            ...
            console.log("Error While WriteLocalScenes.");
            $.mobile.changePage("index.html#errorDialog");
            $('#lbl_errordia').html('Error in Communication,Please try again or check network connection. ErrCode:123');
